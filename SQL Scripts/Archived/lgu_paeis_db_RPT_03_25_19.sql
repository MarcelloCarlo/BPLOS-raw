...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2019 at 10:43 PM
...
CREATE TABLE `rpt_r_assessment_lvl` (
...
CREATE TABLE `rpt_r_mrktval_agri` (
...
CREATE TABLE `rpt_r_mrktval_bldg` (
...
CREATE TABLE `rpt_r_mrktval_land` (
...
CREATE TABLE `rpt_r_property_class` (
  `PC_ID` int(7) NOT NULL,
...
CREATE TABLE `rpt_r_property_type` (
  `PT_ID` int(7) NOT NULL,
...
CREATE TABLE `rpt_t_official_receipt` (
