...
<jsp:include page="DivRSComponent.jsp"></jsp:include>
                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            <tr>
                                ...
                                <td>1,000</td>
                                <td>
                                    <a href="#modal-processpayment" class="btn btn-success btn-xs" data-toggle="modal">Process Permit</a>
                                </td>
                            </tr>
                            <%--<%--%>
                            <%--}--%>
...
<jsp:include page="DivRSFooter.jsp"></jsp:include>
