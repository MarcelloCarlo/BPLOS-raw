...
<head>
    <meta charset="utf-8"/>
    <title>LGU PAEIS | Occupational Form</title>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content" style="padding: 20px 70px;">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Occupational Permit
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
                            ...
                            <div class="row">
                                <!-- begin col-8 -->
                                <div class="col-md-6">
                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Personal
                                        info about yourself
                                    </legend>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="afname" id="afname" placeholder="Juan"
                                                   class="form-control"/>
                                        </div>

                                        <div class="col">
                                            <label>Middle Name</label>
                                            <input type="text" name="amname" id="amname" placeholder="Tamad"
                                                   class="form-control"/>
                                        </div>

                                        <div class="col">
                                            <label>Surname</label>
                                            <input type="text" name="asname" id="asname" placeholder="Dela Cruz"
                                                   class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        <div class="col">
                                            <label>Address</label>
                                            <textarea class="form-control m-b-10" name="aaddr" id="aaddr" rows="3"
                                                      placeholder="Quezon City"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" placeholder="select date"
                                                   name="abday" id="datepicker-autoClose"/>
                                        </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="acnum" id="acnum" placeholder="0999-5022-093"
                                                   class="form-control"/>
                                        </div>
                                ...
                                <!-- begin col-4 -->
                                <div class="col-md-6">
                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Company
                                        Info
                                    </legend>
                                    ...
                                    <div class="form-group row m-b-10">
                                        <div class="col">
                                            ...
                                            <textarea class="form-control m-b-10" name="aworkplace" id="aworkplace"
                                                      rows="3" placeholder="Quezon City"></textarea>
                                        </div>
                                    </div>
    ...
    <div class="theme-panel">
        ...
        <div class="theme-panel-content">
            ...
            <div class="row m-t-10">
                <div class="col-md-12">
                    <a href="javascript:;" class="btn btn-inverse btn-block btn-sm" data-click="reset-local-storage">Reset
                        Local Storage</a>
                </div>
            </div>
        </div>
