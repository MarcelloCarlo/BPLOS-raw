            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    ...
                    <div class="panel-body">
                        <a href="#modal-adduser" class="btn btn-sm btn-primary" data-toggle="modal">Add Business Nature
                            Requirement</a>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            %>
                            <tr>
                                <td><%=res.getString("BPR_NAT")%>
                                </td>
                                <td><%=res.getString("BPR_NATC")%>
                                </td>
                                <td><%=res.getString("BPR_BNRC")%>
                                </td>
                                <td><%=res.getString("BPR_REQ")%>
                                </td>
                                <%--<td>--%>
