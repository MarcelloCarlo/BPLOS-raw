...
<head>
    <meta charset="utf-8" />
    <title>PAEIS | Business Nature Requirement Configuration</title>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            <li>Configurables</li>
            <li class="active">Business Nature Requirement</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Business Nature Requirement Configuration</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title">Business Nature Requirement</h4>
                    </div>
                    <div class="panel-body">
                        <a href="#modal-adduser" class="btn btn-sm btn-primary" data-toggle="modal">Add Business Nature Requirement</a>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            %>
                            <tr>
                                <td><%=res.getString("BPR_NAT")%></td>
                                <td><%=res.getString("BPR_NATC")%></td>
                                <td><%=res.getString("BPR_BNRC")%></td>
                                <td><%=res.getString("BPR_REQ")%></td>
                                <%--<td>--%>
                                    <%--<a href="PAEISSABusPerReqUpdate.jsp?u=<%=res.getString("BPR_ID")%>" class="btn btn-success">Edit</a>--%>
                                <%--</td>--%>
                            </tr>
                            <%
                                }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="panel panel-inverse panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">Add Business Nature Requirement</h4>
                        </div>
                        <div class="panel-body">
                            <form action="PAEISSABusPerReqInsert.jsp" method="POST">

                                <div>
                                    <fieldset>
                                        <legend class="pull-left width-full">Business Nature Requirement</legend>
                                        <!-- begin row -->
                                        <div class="row">
                                                    ...
                                                    <div class="controls">
                                                        <select name="bnc" class="form-control">
                                                            ...
                                                            <option value="<%out.print(ss.getInt("BN_ID"));%>">
                                                                <%out.print(ss.getString("BNR_CODE"));%>
                                                            </option>
                                                            <%
                                                                }
                                                            %>
                                                    ...
                                                    <div class="controls">
                                                        <select name="req" class="form-control">
                                                            ...
                                                            <option value="<%out.print(ssss.getInt("RREQ_ID"));%>">
                                                                <%out.print(ssss.getString("RREQ_NAME"));%>
                                                            </option>
                                                            <%
                                                                }
                                                            %>
