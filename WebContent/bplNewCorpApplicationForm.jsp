							...
							<div class="row">
								...
								<div class="col-xs-12">
									<div class="form-group">
										<label>Business Location <small>(Indicate
												exact address)</small> <span class="required">*</span>
										</label>
									</div>
									<div class="form-group col-xs-12">
										<div class="col-md-4">
										...
										<div class="form-group col-md-12">
											...
											<div class="col-md-3">
												<label>No of Employees <span class="required">*</span>
													...
													class="form-control number" placeholder=" " required="required">
											</div>
										...
										<table class="table table-bordered">
											<thead>
												<tr>
													...
													<th>Unit <br> <small>No./Qty</small>
													</th>
													<th>Area <br> <small>Sq. Mts.</small>
													</th>
													<th>Capitalization <br> <small>Subscribed
															or Paid-Up</small> (PHP)
													</th>
												</tr>
											</thead>
											<tbody>
