...
<%@page import="java.sql.*,,,,,,,,,,,javax.servlet.http.HttpServletRequest,javax.servlet.http.HttpServletResponse,javax.servlet.http.Part,java.util.Date,java.util.Iterator,java.ut
<%@page import="java.io.*" %>
...
<%// Form Inputs First. F.Y.I., I will declare at least 82+ variables in here,
        ...
        try {
            ...
            callProc = (com.mysql.jdbc.CallableStatement) connection.prepareCall(
                    "{ call lgu_application_sp(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
