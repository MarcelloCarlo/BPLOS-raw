...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Marketing Value (Land)</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Marketing Value (Land)</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Marketing Value (Land) Tables</h4>
                    </div>
                    <div class="panel-body">
                        <a href="#modal-addcont" id="addContbtn" class="btn btn-sm btn-primary" data-toggle="modal">Add Marketing Value (Land)</a>
                    </div>
                    <div class="panel-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="panel panel-inverse panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">Marketing Value (Land)</h4>
                        </div>
                        <div class="panel-body">
                            <form enctype="multipart/form-data">
                                ...
                                <div>
                                    <fieldset>
                                        <legend class="pull-left width-full">Marketing Value (Land)</legend>
                                        <!-- begin row -->
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Value</label>
                                                    <div class="controls">
                                                        <input type="text" name="addlandvalue"
                                                               placeholder="Value"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Value</label>
                                                    <div class="controls">
                                                        <input type="text" name="editlandvalue"
                                                               placeholder="Value"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
