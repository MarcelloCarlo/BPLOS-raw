...
<head>
    ...
    <title>BPLS | Evaluated Reports</title>
...
<%
    ...
    try {
        ...
        gg3 = ss3.executeQuery("SELECT * FROM bpls_t_bp_application JOIN bpls_t_business business on bpls_t_bp_application.BU_ID = business.BU_ID JOIN bpls_r_business_nature nature on business.BN_ID = nature.BN_ID WHERE AP_DIV_CODE_FROM = 'DIV-EV' ");%>
<body>
    ...
    >
        <div class="">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">Evaluated Reports</li>
            </ol>
            <!-- begin page-header -->
            <h1 class="page-header">Evaluated Reports</h1>
            <!-- end page-header -->
            <div class="row">
                <div class="col-md-12">
                    <!-- begin panel -->
