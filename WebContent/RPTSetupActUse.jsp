...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Actual Use</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Actual Use</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Actual Use Tables</h4>
                    </div>
                    <div class="panel-body">
                        <a href="#modal-addcont" id="addContbtn" class="btn btn-sm btn-primary" data-toggle="modal">Add Actual Use</a>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            %>
                            <tr>
                                <td class="hide"><%=res.getString("AU_ID")%></td>
                                <td><%=res.getString("AU_CODE")%>
                                </td>
                                <td><%=res.getString("AU_DESC")%>
                                </td>
                                <td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="addactusecode" placeholder="Code"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="editactusecode" placeholder="Code"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
