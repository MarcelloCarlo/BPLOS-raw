                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action=" " method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="divcode" class="form-control"
                                           value='<%=res.getString("DIV_CODE")%>'/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Division Name</label>
                                <div class="col-md-8">
                                    <input type="text" name="divname" class="form-control"
                                           value='<%=res.getString("DIV_NAME")%>'/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Division Description</label>
                                <div class="col-md-8">
                                    <input type="text" name="divdesc" class="form-control"
                                           value='<%=res.getString("DIV_DESC")%>'/>
                                </div>
                            </div>
