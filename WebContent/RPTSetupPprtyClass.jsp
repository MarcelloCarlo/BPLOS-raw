...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Property Class</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Property Class</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Property Class Tables</h4>
                    </div>
                    <div class="panel-body">
                        <a href="#modal-addcont" id="addContbtn" class="btn btn-sm btn-primary" data-toggle="modal">Add Property Class</a>
                    </div>
                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="addpclasscode" placeholder="Code"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="editpclasscode" placeholder="Code"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
