...
var handleDatepicker = function () {
    ...
    $("#jquery-autocomplete").autocomplete({source: a})
    ...
    $("#datetimepicker1").datetimepicker(), $("#datetimepicker2").datetimepicker({format: "LT"}), $("#datetimepicker3").datetimepicker(), $("#datetimepicker4").datetimepicker(), $("#datetimepicker3").on("dp.change", function (a) {
    ...
    var a = {colors: [["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#EFF7F7", "#FFFFFF"]]};
