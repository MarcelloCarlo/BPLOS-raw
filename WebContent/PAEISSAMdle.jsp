                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            <%
                                ...
                                String data = "select * from bpls_r_module order by MOD_ID desc";
                                res = stat.executeQuery(data);
                                while (res.next()) {
                            %>
                            <tr>
                                <td><%=res.getString("MOD_NAME")%>
                                </td>
                                <td><%=res.getString("MOD_DESC")%>
                                </td>
                                <td>
                                    <a href="PAEISSAMdleUpdate.jsp?u=<%=res.getString("MOD_ID")%>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="modname" placeholder="Module Name"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="modesc"
                                                               placeholder="Module Description" class="form-control"
                                                               required/>
                                                    </div>
                                                </div>
                                            </div>
