...
<head>
    ...
    <title>BPLS | Collection Officer</title>
...
<jsp:include page="BPLSTClctnOfcrComponent.jsp"></jsp:include>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Payment Audit</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Payment Audit</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        <h4 class="panel-title">Payment Audit Table</h4>
                    </div>
