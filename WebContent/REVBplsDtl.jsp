...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">BPLS Details</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">BPLS Details</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse panel-danger">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">BPLS Details</h4>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            <%
                                ...
                                PreparedStatement getBplsOr = (PreparedStatement) con9.prepareStatement("SELECT `OR_ID`, `OR_DATE`, `OR_PYMT_TYPE`, `OR_TOTAL_AMOUNT` FROM `bpls_t_official_receipt`");
                                ResultSet res = getBplsOr.executeQuery();
                                while (res.next()) {
                            %>
                            <tr>
