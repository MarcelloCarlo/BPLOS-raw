...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Marketing Value (Agricultural)</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Marketing Value (Agricultural)</h1>
        <!-- end page-header -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="panel panel-inverse panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">Marketing Value (Agricultural)</h4>
                        </div>
                        <div class="panel-body">
                            <form enctype="multipart/form-data">
                                ...
                                <div>
                                    <fieldset>
                                        <legend class="pull-left width-full">Marketing Value (Agricultural)</legend>
                                        <!-- begin row -->
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="addagripclass" class="form-control">
                                                            <option value="  "> </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="addagricode"
                                                               placeholder="Code"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="addagridesc"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="addagricat"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Property Class</label>
                                                    <div class="controls">
                                                        <select name="editagripclass" class="form-control">
                                                            <option value="  "> </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Code</label>
                                                    <div class="controls">
                                                        <input type="text" name="editagricode"
                                                               placeholder="Code"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Description</label>
                                                    <div class="controls">
                                                        <input type="text" name="editagridesc"
                                                               placeholder="Description"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Category</label>
                                                    <div class="controls">
                                                        <input type="text" name="editagricat"
                                                               placeholder="Category"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
