...
<div id="page-container" class="page-without-sidebar ">
    ...
    <div id="content" class="content">
        <!-- begin page-header -->
        <h1 class="page-header hidden-print">Permit</h1>
        <!-- end page-header -->
        ...
        <div class="invoice">
            ...
            <div class="invoice-note">
                * This is a printed copy of the registered Motorized Tricycle Operator's Permit
            </div>
        </div>
        <!-- end invoice -->
    </div>
