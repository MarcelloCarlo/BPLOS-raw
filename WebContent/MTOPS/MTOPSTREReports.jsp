...
<head>
    ...
    <title>MTOPS | Treasury Reports</title>
...
<%
    ...
    try {
        ...
        ResultSet gg3 = ss3.executeQuery("SELECT * FROM mtops_t_official_receipt MAF JOIN mtops_t_application_frm FRM ON MAF.APF_ID = FRM.APF_ID");%>
<body>
<!-- begin #page-loader -->
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Treasury Reports</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Treasury Reports</h1>
        <!-- end page-header -->
