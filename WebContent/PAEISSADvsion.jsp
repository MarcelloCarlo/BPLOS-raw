                ...
                <div class="panel panel-inverse panel-danger">
                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            %>
                            <tr>
                                <td><%=res.getString("DIV_CODE")%>
                                </td>
                                <td><%=res.getString("DIV_NAME")%>
                                </td>
                                <td><%=res.getString("DIV_DESC")%>
                                </td>
                                <td>
                                    <a href="PAEISSADvsionUpdate.jsp?u=<%=res.getString("DIV_ID")%>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="divcode" placeholder="Division Code"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="divname" placeholder="Division Name"
                                                               class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="divdesc"
                                                               placeholder="Division Description" class="form-control"
                                                               required/>
                                                    </div>
                                                </div>
                                            </div>
